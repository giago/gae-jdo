package com.giago.appengine.commons.dao.jdo;
...
import com.giago.appengine.commons.dao.PMF;
...
public abstract class BaseDaoImpl<M> implements BaseDao<M> {
	...
	protected abstract class QueryPersonalizer {		
		...
		protected String getEqualStringFilter(String property, String value) {
			return property + QUERY_EQUALS + STRING_VALUE_SEPARATOR + value + STRING_VALUE_SEPARATOR;
		}
		
		protected String getNotEqualStringFilter(String property, String value) {
			return property + QUERY_NOT_EQUALS + STRING_VALUE_SEPARATOR + value + STRING_VALUE_SEPARATOR;
		}
		
		protected String getEqualLongFilter(String property, Long value) {
			return property + QUERY_EQUALS + value;
		}
